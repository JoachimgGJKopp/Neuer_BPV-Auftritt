...
<html lang="de">
<head>
    <title>Ergebnis Jubiläumsturnier 2024</title>
...
<body>
    ...
    <div>
        ...
        <div id="ergebnis">
            ...
            <h2>Ergebnis Jubiläumsturnier 2024 - Doublette Formée A-C-B-D k.o.</h2>

            <p>Hier die <a target="_blank"href="imagefolder/Jubiläumsturnier_2024/ErgJubi2024.jpg">Ergebnisliste</a> als JPG.</p>


	        <p><strong>A-Turnier:</strong></p>

			<p>1. Anthony Weiss und Steve Hoert, beide Hattenoise;<br>
			2. Niclas Zimmer, Ft Freiburg, und Andreas Herrmann, BPV Freiburg;<br>
            3. Cedric Steck und Jonathan Texeire-Oliveira, beide Hattenoise;<br>
			...
			<p><strong>C-Turnier:</strong></p>

            <p>1. Bryan Haag und Christophe Weiss, beide Oberhoffen;<br>
			2. Alexander Ehret, BPV Freiburg, und Denis Margathe, Rheinhausen;<br>
			3. Tim Nitsch und Fabian Spann, BBBC Singen;<br>
			3. Thomas Haas und Mathias Ungerer, beide BC Rastatt.</p>

            <p><strong>D-Turnier:</strong></p>
			...
			<p>Wir danken Cornelia und unserer Dritten Mannschaft für ihren unerwartet heftigen 
			Arbeitseinsatz, besonders unseren Elsässern.</p>

            <p>An der Kamera war Jutta Schmidt.</p>

			<p>Schiedsrichter war Youcef Hamoudi, BPV Freiburg, dem wir danken.</p>

			<p>Das Turnier leiteten erfolgreich Hansjörg Grund und Joachim Kopp.</p>
