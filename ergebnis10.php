...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <h2 class="ps-0 mt-4">Ergebnis 22. Jubiläumsturnier 2023 (Doublette Formée)</h2>
            ...
            <div class="col-12 col-sm-12 ps-0 pe-0">
                ...
                <p style="color: var(--sub-color);"><strong>Ergebnis A-Turnier</strong></p>
                ...
                <p style="color: var(--sub-color);"><strong>Ergebnis D-Turnier</strong></p>
