...
<body>
    ...
    <teaser id="teaser">
        <img src="images/turnierszene4.jpg" title="Frühling auf dem Platz" alt="Frühling auf dem Platz" style="margin-bottom: 3em;">
    </teaser>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <h2 class="ps-0 mb-4">Impressum</h2>
            ...
            <div class="col-12 col-sm-12 ps-0 pe-0">
                ...
                <h3>Konzeption und Design</h3>
                    ...
                    <p>Joachim Kopp und Andreas Schulz</p>
