...
<body>
    ...
    <img src="images/TeasMeinung.jpg" title="Rhododendren im Seepark" alt="Rhododendren im Seepark" style="margin-bottom: 2em;">

    <div class="container-fluid">

        <div class="row">

            <h2 class="mb-3 ps-0">Erwin Müller aus Mühlacker schreibt uns:</h2>

            <div class="col-12 col-sm-6 pe-sm-3 ps-0">
            ...
            <div class="col-12 col-sm-6 ps-0 pe-0">
                ...
                <p>interessant geometrischen Formen dazwischen verteilt, geben dem Gesamtbild eine 
